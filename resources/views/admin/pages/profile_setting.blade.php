      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <img src="{{ ($user->user_pic ?? '') ? asset('storage/'.$user->user_pic) : asset('assets/admin/img/profile-img1.png') }}" alt="Profile" class="rounded-circle">
            <h2>{{$user->name }}</h2>
                ...
                <form class="row g-3 mt-3 needs-validation" method="post" action="{{ route('admin.profileSetting') }}" novalidate enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <img id="img_preview" src="{{ ($user->user_pic ?? '') ? asset('storage/'.$user->user_pic) : asset('assets/admin/img/profile-img1.png') }}" alt="Profile">
                      <div class="pt-2">
