                ...
                <div class="col-md-4 col-sm-4  col-lg-3">
                    <div class="profile-widget">
                        <div class="doctor-img">
                            <a class="avatar" href="profile.html"> <img class="img-fluid"
                                    src="http://127.0.0.1:8000/assets/admin/img/profile-img.jpg" alt=""></a>
                        </div>
                        <h4 class="doctor-name text-ellipsis"><a href="profile.html">Cristina Groves</a></h4>
                        <div class="doc-prof">Gynecologist</div>
                        <div class="user-country">
                            <i class="bi bi-geo-alt-fill"></i> United States, San Francisco
                        </div>
                        <div class="row">
