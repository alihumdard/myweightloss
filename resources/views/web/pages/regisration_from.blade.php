...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <div class="container">
                            ...
                            <div class="steps mt-5 mb-1 is-tablet-medium">
                                ...
                                <div class="step-item">
                                    <div class="step-marker" style="background: #4DC4D8;"><span
                                            class="step-number-text">2</span><span
                                            class="icon-consultation-icon"></span>
                                    </div>
                                    <div class="step-details">
                ...
                <div class="main-sec mt-4 mb-5">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 left-boxs"
                            style=" border-right: 1px solid #e5eef3;">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-7">
                            <div class="full-form">
                                <div class="user-text mt-2">
                                    ...
                                    <button id="btnlogin" class="account-btn" data-toggle="modal"
                                        data-target="#loginModal">ٰI have an account</button>
                                </div>
                                <div>
                                    <form class="mt-3 needs-validation" method="post"
                                        action="{{ route('web.register') }}" novalidate>
                                        @csrf
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-6 mt-3">
                                                <div class="form-group">
                                                    <label for="height"
                                                        class=" mb-2 text-left font-weight-bold">Height</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="number" name="zip_code"
                                                        id="zip_code" value="" placeholder="Enter your zip code">
                                                    <div class="mt-1">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mx-auto font-weight-bold" id="exampleModalLabel"
                            style="font-family: sans-serif;  letter-spacing: 2px;">LogIn </h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="email" name="email" class="form-control" id="user_email"
                                    value="{{ session('email') ?? ''}}" required aria-describedby="emailHelp"
        ...
        <script>
            ...
            $('#l                    , #loginModal [data-dismiss="mod                lick            ion (                            $('#loginM odal'                e');
                });
            $(document).re                    {
