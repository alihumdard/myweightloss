                        ...
                        <div class="step" data-state="branchtype">
                            ...
                            <div class="row">
                                ...
                                <div class="row align-items-center d-flex justify-content-center">
                                    <div
                                        class="col-lg-3 col-md-6 animated zoomIn delay-fast d-flex justify-content-center">
                                        <div class="item">
                                            <input id="answer_1" type="radio" name="branch_1_group_1"
                                                value="Seo-Optimization" class="required">
                                            <label for="answer_1">
                                                <img src="{{ asset('/assets/web/bmi/img/weightloss/11.png') }}"
                                                    class="bmi-main-images" alt="">
                                            </label>
                                        </div>
                                    </div>
                                    <div
                                        class="col-lg-3 col-md-6 animated zoomIn delay-normal d-flex justify-content-center">
                                        <div class="item">
                                            <input id="answer_2" name="branch_1_group_1" type="radio"
                                                value="Seo-Optimization" class="required">
                                            <label for="answer_2">
                                                <img src="{{ asset('/assets/web/bmi/img/weightloss/4(1).png') }}"
                                                    class="bmi-main-images" alt="">
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 animated zoomIn delay-fast">
                                        <div class="item text-center">
                                            <input id="branch_2_answer_1" type="radio" name="branch_1_group_1"
                                                value="Seo-Optimization" class="required">
                                            <label for="branch_2_answer_1">
                                                <img src="{{ asset('/assets/web/bmi/img/11.png') }}" alt=""
                                                    class="img-fluid mb-2">
                                                <button type="button" name="forward"
                                                    class="forward btn btn-sm btn-primary">18-25</button>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 animated zoomIn delay-normal">
                                        <div class="item text-center">
                                            ...
                                            <label for="branch_2_answer_2">
                                                <img src="{{ asset('/assets/web/bmi/img/7.png') }}" alt=""
                                                    class="img-fluid mb-2">
                                                <button type="button" name="forward"
                                                    class="forward btn btn-sm btn-primary">26-35</button>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 animated zoomIn delay-medium">
                                        <div class="item text-center">
                                            <input id="answer_3" name="branch_1_group_1" type="radio" value="Design"
                                                class="required">
                                            <label for="answer_3">
                                                <img src="{{ asset('/assets/web/bmi/img/10.png') }}" alt=""
                                                    class="img-fluid mb-2">
                                                <button type="button" name="forward"
                                                    class="forward btn btn-sm btn-primary">36-45</button>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 animated zoomIn delay-medium">
                                        <div class="item text-center">
                                            <input id="answer_4" name="branch_1_group_1" type="radio" value="Design"
                                                class="required">
                                            <label for="answer_4">
                                                <img src="{{ asset('/assets/web/bmi/img/4.png') }}" alt=""
                                                    class="img-fluid bg-white mb-2">
                                                <button type="button" name="forward"
                                                    class="forward btn btn-sm btn-primary">46+</button>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row m-2">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="height"
                                                            class="mb-3 text-left font-weight-bold">Height</label>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="weight"
                                                            class="mt-3 text-left font-weight-bold">Weight</label>
