        ...
        <div class="row">
            <div class="col-12">
                <div class="slick-carousel" data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "autoplay": true, "arrows": true, "dots": false, "responsive": [ {"breakpoint": 992, "settings": {"slidesToShow": 2}}, {"breakpoint": 767, "settings": {"slidesToShow": 2}}, {"breakpoint": 480, "settings": {"slidesToShow": 1}}]}'>
                    <a class="popup-gallery-item" href="{{ asset('/assets/web/images/gallery/1.png') }}">
                        <img src="{{ asset('/assets/web/images/gallery/1.png') }}" alt="gallery img">
                    </a>
                    <a class="popup-gallery-item" href="{{ asset('/assets/web/images/gallery/2.png') }}">
                        <img src="{{ asset('/assets/web/images/gallery/2.png') }}" alt="gallery img">
                    </a>
                    ...
                    <a class="popup-gallery-item" href="{{ asset('/assets/web/images/gallery/5.png') }}">
                        <img src="{{ asset('/assets/web/images/gallery/5.png') }}" alt="gallery img">
                    </a>
                    <a class="popup-gallery-item" href="{{ asset('/assets/web/images/gallery/6.png') }}">
                        <img src="{{ asset('/assets/web/images/gallery/6.png') }}" alt="gallery img">
                    </a>
